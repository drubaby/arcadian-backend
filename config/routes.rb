Rails.application.routes.draw do
  ...
  resources :machines
  resources :machine_types, only: [:index, :show]
  resources :locations, only: [:index, :show, :create]
  get "/machines_at_location/:id", to: "machines#find_for_location"
  post "/update_location_by_issue", to: "machine_issues#update_location_by_issue"
  post "update_location_by_machine", to: "machines#update_location_by_machine"
